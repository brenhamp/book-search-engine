...
Clone the repository, run 'npm i' to install dependencies and 'npm start' to run the server. Or use the deployed application on Heroku. Then you may choose to 
